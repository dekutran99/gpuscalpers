...
(async () => {
    ...
    while (!isPageLoaded) {
        try {
            let response = await page.goto('https://www.bestbuy.ca/en-ca/product/msi-nvidia-geforce-rtx-3060-ti-ventus-2x-oc-8gb-gddr6-video-card/15178453', { timeout: 30000 });

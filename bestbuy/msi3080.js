...
(async () => {
    ...
    while (!isPageLoaded) {
        try {
            let response = await page.goto('https://www.bestbuy.ca/en-ca/product/msi-nvidia-geforce-rtx-3080-ventus-3x-10gb-gddr6x-video-card/14950588', { timeout: 30000 });
            ...
            try {
                ...
                await page.click('text=MSI NVIDIA GeForce RTX 3080 VENTUS 3X 10GB GDDR6X Video Card', { timeout: 30000 });
                isPageLoaded = true;
            } catch (err) {
                console.error(err);

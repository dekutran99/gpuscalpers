...
(async () => {
    ...
    while (!isPageLoaded) {
        try {
            let response = await page.goto('https://www.bestbuy.ca/en-ca/product/zotac-nvidia-geforce-rtx-3080-trinity-10gb-gddr6x-video-card/14953249', { timeout: 30000 });
            ...
            try {
                ...
                await page.click('text=ZOTAC NVIDIA GeForce RTX 3080 Trinity 10GB GDDR6X Video Card', { timeout: 30000 });
                isPageLoaded = true;
            } catch (err) {
                console.error(err);

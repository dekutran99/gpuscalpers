...
(async () => {
    ...
    while (!isPageLoaded) {
        try {
            let response = await page.goto('https://www.bestbuy.ca/en-ca/product/asus-rog-strix-nvidia-geforce-rtx-3080-10gb-gddr6x-video-card/14954116', { timeout: 30000 });
            ...
            try {
                ...
                await page.click('text=ASUS ROG Strix NVIDIA GeForce RTX 3080 10GB GDDR6X Video Card', { timeout: 30000 });
                isPageLoaded = true;
            } catch (err) {
                console.error(err);

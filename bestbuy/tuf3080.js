...
(async () => {
    ...
    while (!isPageLoaded) {
        try {
            let response = await page.goto('https://www.bestbuy.ca/en-ca/product/asus-tuf-gaming-nvidia-geforce-rtx-3080-10gb-gddr6x-video-card/14953248', { timeout: 30000 });
            ...
            try {
                ...
                await page.click('text=ASUS TUF Gaming NVIDIA GeForce RTX 3080 10GB GDDR6X Video Card', { timeout: 30000 });
                isPageLoaded = true;
            } catch (err) {
                console.error(err);
